...
describe("when there is initially some workouts saved", () => {
  ...
  it("Should include a specific workout in returned list", async () => {
    console.log("entered test");
    const response = await api.get("/api/workouts");
  ...
  it("should be able to add a valid workout", async () => {
    console.log("entered test");
    const newWorkout = {
      title: "Situps",
      reps: 25,
  ...
  it("should not add a workout without title", async () => {
    console.log("entered test");
    const newWorkout = {
      reps: 23,
    };
